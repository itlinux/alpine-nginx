...
LABEL description="This container has some basic networking tools"
LABEL maintainer="remo@mattei.org"
...
CMD ["nginx"]
RUN apk add bind-tools curl bash iputils vim busybox-extras httpie jq tcpdump tcptraceroute util-linux vim openssl iperf apache2-utils
